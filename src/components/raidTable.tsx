...
export class RaidTable extends React.Component<Props> {
    constructor(props:any){
        super(props)

        store.getcurrentMemberFlags();

        console.log(store.isLeader);
                        ...
                        <table className="table table-sm text-center">
                            <Header />
                            {
                                ...
                                <tbody>
                                    <tr>
                                        <td colSpan={3}>
                                            <button className="btn btn-outline-success" onClick={store.addUser}>
                            ...
                            }
                            {
                                ...
                                <tbody>
                                    <tr>
                                        <td colSpan={store.isLeader ? 5 : 3}></td>
                                        <td>1</td>
                                        <td>2</td>
                                        <td>3</td>
                                        <td>4</td>
                ...
                <div className="card-footer">
                    <div className="row">
                        <div className="col-2 my-auto">
                            {store.raids[0].members.length}/{store.raids[0].maxMembers}
                        </div>
